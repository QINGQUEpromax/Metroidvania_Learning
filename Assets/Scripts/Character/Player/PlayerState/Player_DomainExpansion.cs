...
public class Player_DomainExpansion : PlayerState
{
    ...
    public Player_DomainExpansion(Player player, StateMachine stateMachine, string stateName) : base(player, stateMachine, stateName)
    {
    }
